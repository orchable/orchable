-- Migration: Fix increment_finished_task Type Mismatch for Enum Conversion
-- Description: Updates the v_new_status variable type to public.ai_task_status to match the updated column type.
