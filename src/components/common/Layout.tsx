    ...
    <SidebarProvider defaultOpen={!isLandingPage}>
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          {/* Header */}
          {isLandingPage ? (
            <div className="sticky top-0 z-50 bg-background/60 backdrop-blur-md border-b border-primary/5 transition-colors duration-300">
              <AnnouncementBar />
              <LandingNav />
            </div>
          ) : (
            <header className="h-14 border-b bg-card/50 backdrop-blur-sm flex items-center justify-between px-4 sticky top-0 z-40">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-muted-foreground font-medium">Orchable | AI Agent Orchestrator</span>
              </div>
                ...
                {user ? (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56" align="end" forceMount>
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="text-destructive focus:bg-destructive/10 focus:text-destructive cursor-pointer" onClick={handleSignOut}>
